          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-12" style="">
                <h2 class="text-primary" style=""><b>PK-GJA</b></h2>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
...
?>
        ...
        pointFormat: '<tr><td style="color: {series.color}">{series.name}: </td>' +
            ...
            color: '<?php
                    include 'koneksi.php';
                    $query = mysqli_query($connect,"SELECT * FROM tampung_all WHERE kode='PK-GJA' ORDER BY id DESC LIMIT 1");
                  ...
                  <div class="col-md-12">
                    <div class="col-md-12" style="">
                      ...
                      <form method="post">
                        ...
                        <?php $no++; } ?>
                        <?php } ?>
                        <div class="col-md-12 text-left"><a class="btn btn-primary bg-aquamarine" href="../reportdatacitilink/gja/report2020.php">View More</a></div>
                      </form>
                    </div>
                  </div>
                </div>
