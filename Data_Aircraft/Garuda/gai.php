          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-12" style="">
                <h2 class="text-primary" style=""><b>PK-GAI</b></h2>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="col-md-12" style="">
                      ...
                      <form method="post">
                        ...
                        <?php $no++; } ?>
                        <?php } ?>
                        <div class="col-md-12 text-left"><a class="btn btn-primary bg-aquamarine" href="../reportdatagaruda/gai/report2020.php">View More</a></div>
                      </form>
                    </div>
                  </div>
                </div>
