      ...
      <div class="row" style="">
        <div class="p-3 bg-white col-md-12 border mt-3 input-group" style="">
          <div class="col-md-12">
            ...
            <h3 class="text-primary text-center mt-4" style=""><b>Stargen Brush</b></h3>
            <div class="row my-3">
                                              ...
                                              <div class="col-md-12 my-3" style="">
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <div class="row">
                                                      <div class="col-md-12">
                                                        <p class="mt-3 text-danger"><span style="font-weight: 400;"><i>Stargen Brush All Aircraft Garuda</i></span></p>
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
