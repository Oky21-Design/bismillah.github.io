              ...
              <div class="col-md-12">
                ...
                <div class="tab-content mt-2">
                  <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                            <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-01-01' AND '2020-01-31' ORDER BY tanggal ASC LIMIT 31";
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-02-01' AND '2020-02-29' ORDER BY tanggal ASC LIMIT 29";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-03-01' AND '2020-03-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-04-01' AND '2020-04-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-05-01' AND '2020-05-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-06-01' AND '2020-06-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-07-01' AND '2020-07-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-08-01' AND '2020-08-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-09-01' AND '2020-09-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-10-01' AND '2020-10-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-11-01' AND '2020-11-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAM' AND tanggal BETWEEN '2020-12-01' AND '2020-12-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
