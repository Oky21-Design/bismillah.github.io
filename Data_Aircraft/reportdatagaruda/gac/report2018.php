      ...
      <div class="row" style="">
        <div class="p-3 bg-white col-md-12 border input-group py-4 mt-4" style="">
          <div class="col-md-12">
            ...
            <h3 class="text-primary text-center" style=""><b>Garuda PK-GAC</b></h3>
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="tab-content mt-2">
                  <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                            <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-01-01' AND '2018-01-31' ORDER BY tanggal ASC LIMIT 31";
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-02-01' AND '2018-02-28' ORDER BY tanggal ASC LIMIT 29";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-03-01' AND '2018-03-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-04-01' AND '2018-04-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-05-01' AND '2018-05-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-06-01' AND '2018-06-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-07-01' AND '2018-07-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-08-01' AND '2018-08-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-09-01' AND '2018-09-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-10-01' AND '2018-10-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-11-01' AND '2018-11-30' ORDER BY tanggal ASC LIMIT 30";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
                  ...
                  <?php
                              require('koneksi.php');
                              $sql = "SELECT * FROM tampung_all WHERE kode='PK-GAC' AND tanggal BETWEEN '2018-12-01' AND '2018-12-31' ORDER BY tanggal ASC LIMIT 31";
                              $result = mysqli_query($connect, $sql);
                            ?>
                    <div class="row">
                      <div class="col-md-12">
