...
<body class="text-center">
  ...
  <div class="py-5" style="background-image: url(&quot;../../assets/Team/fix.png&quot;);	background-position: top left;	background-size: 100%;	background-repeat: no-repeat;">
    <div class="container">
      ...
      <div class="row" >
        <div class="p-3 bg-white col-md-12 border mt-3 input-group" >
          <div class="col-md-12">
            <div class="row">
            ...
            <h3 class="text-primary text-center mt-4" ><b>Ac Temperature</b></h3>
            <div class="row">
                              ...
                              <div class="col-md-12">
                                <div class="row">
                                  <div class="col-md-6 my-2">
                                    <div class="grid-margin stretch-card card input-group col-md-12" >
                                              ...
                                              <div class="col-md-12 my-3" >
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <div class="row">
                                                      <div class="col-md-12">
                                                        <p class="mt-3 text-danger"><span style="font-weight: 400;"><i>Ac Temperature All Aircraft Citilink</i></span></p>
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
