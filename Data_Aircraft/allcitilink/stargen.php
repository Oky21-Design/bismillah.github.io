      ...
      <div class="row" style="">
        <div class="p-3 bg-white col-md-12 border mt-3 input-group" style="">
          <div class="col-md-12">
            ...
            <h3 class="text-primary text-center mt-4" style=""><b>Citilink Monitoring Stargen Brush</b></h3>
            <div class="row my-3">
              <div class="col-md-12" style="">
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-12">
                      <form method="get" class="form-inline mt-5 mb-1">
                        <div class="form-group">
                          <div class="form-group text-left"><label class=""></label><input type="date" name="tanggal" class="form-control form-control-sm border" placeholder="Input Your Answer" required="required" style=""></div>
                        </div>
                        <div class="form-group">
                          <div class="form-group text-left"><label class=""><b contenteditable="true">&nbsp; to&nbsp;&nbsp;</b></label><input type="date" name="tanggal2" class="form-control form-control-sm border" placeholder="Input Your Answer" required="required" style="">
                            <div class="form-group row">
                              <div class="col-10">
                                <div class="row">
                                  <div class="col-md-12 ml-3"><button class="btn btn-primary bg-aquamarine" type="submit"><i class="fa fa-search"></i></button></div>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            plotLines: [{
                ...
                series: <?php echo json_encode($array_series); ?>
                          ...
                          <div class="col-md-6 my-2" style="">
                            <div class="grid-margin stretch-card card input-group col-md-12" style="">
                              <div id="gjp" class="card-body input-group" style="	height: 270px;">
                              <?php
          $conn=mysqli_connect("localhost", "root", "", "air");
// array data
$array_tanggal = array();
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="row">
                                  <div class="col-md-6 my-2">
                                    <div class="grid-margin stretch-card card input-group col-md-12" style="">
                                      <div id="gjr" class="card-body input-group" style="	height: 270px;">
                                      <?php
          $conn=mysqli_connect("localhost", "root", "", "air");
// array data
$array_tanggal = array();
        ...
        pointFormat: '<tr><td style="color: {series.color}">{series.name}: </td>' +
            ...
            plotLines: [{
                ...
                series: <?php echo json_encode($array_series); ?>
                                  ...
                                  <div class="col-md-6 my-2">
                                    <div class="grid-margin stretch-card card input-group col-md-12" style="">
                                      <div id="gjs" class="card-body input-group" style="	height: 270px;">
                                      <?php
          $conn=mysqli_connect("localhost", "root", "", "air");
// array data
$array_tanggal = array();
                                              ...
                                              <div class="col-md-12 my-3" style="">
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <div class="row">
                                                      <div class="col-md-12">
                                                        <p class="mt-3 text-danger"><span style="font-weight: 400;"><i>Stargen Brush All Aircraft Citilink</i></span></p>
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
